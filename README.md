...
A full-stack hospital management system that digitalizes the running of a hospital, built **module by module along one patient's journey**. Phase 0 (foundation) and the **Front Desk / Reception** seat are complete and working end to end.
...
- **Phase 2 — Clinician:** EHR notes, ICD-10 diagnoses, lab/imaging orders, e-prescribing (fills the Encounter created at check-in)
